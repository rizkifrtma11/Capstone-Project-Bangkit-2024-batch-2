...
val locationData = listOf(
    ...
    LocationData("Jakarta", -6.193471068018878, 106.82555855240794, 10000f, "Kerak Telor"),
    LocationData("Jawa Tengah", -7.021713763419635, 110.46179705550247, 20000f, "Lumpia Semarang"),
