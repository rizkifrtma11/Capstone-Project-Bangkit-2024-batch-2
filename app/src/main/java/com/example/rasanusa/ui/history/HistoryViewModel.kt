...
import com.example.rasanusa.data.localdatabase.repository.FoodHistoryRepository
...
//            val predictionHistory = withContext(Dispatchers.IO) {
//                historyDao.getAllHistory()
////                FoodHistoryRoomDatabase.getDatabase(context).foodHistoryDao().getAllHistory()
//            }
//            _listHistoryFood.value = predictionHistory
